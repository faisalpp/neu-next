...
import RatingProductSliderSm from '@/components/Sections/RatingProductSections/RatingProductSliderSm'
...
const RatingProductSectionSm = ({ stars, title }) => {
  ...
  return (
    <>
      <div className='flex lg:hidden flex-col lg:mx-20 py-10' >
        ...
        <div className=' relative px-4 md:px-10 w-full mt-3' >
          <RatingProductSliderSm stars={stars} />
        </div>
        <div className='flex justify-center mt-5' ><Link href='' className='flex items-center border-[1px] border-b3 w-fit px-4 py-1 xl:py-2 rounded-md text-b3 font-semibold' ><span className='lg:text-sm xl:text-[16px] text-xs' >Shop All {stars} Star Cosmetic Rating Appliances</span><BsArrowRightShort className='text-2xl' /></Link></div>
      </div>
    </>
  )
}
